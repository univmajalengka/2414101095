...
<html lang="en">
  <head>
    ...
    <title>Tambah Produk | RIVVORLD Admin</title>
    ...
    <div class="flex min-h-screen flex-col">
      ...
      <main class="mx-auto flex w-full max-w-6xl flex-1 flex-col gap-6 px-6 py-8">
        <section class="flex flex-wrap items-center justify-between gap-4">
          <div>
            <h1 class="text-2xl font-semibold text-neutral-900">Tambah Produk</h1>
            <p class="text-sm text-neutral-500">
              Lengkapi detail produk baru untuk menambahkannya ke katalog RIVVORLD.
            </p>
          </div>
          <a
            href="index.php"
        ...
        <section class="rounded-2xl border border-neutral-200 bg-white p-8 shadow-sm">
          <form action="../controller/ProdukController.php" method="POST" enctype="multipart/form-data" class="space-y-6">
            <input type="hidden" name="createProduk" value="1" />
            ...
            <div class="grid gap-4 md:grid-cols-2">
              ...
              <div class="md:col-span-2">
                ...
                <textarea
                  ...
                  rows="4"
                  class="w-full rounded-xl border border-neutral-200 bg-white px-4 py-2 text-sm text-neutral-800 shadow-sm transition focus:border-neutral-900 focus:outline-none"
                  placeholder="Tulis penjelasan singkat tentang produk"
                ></textarea>
              </div>
              ...
              <div>
                <label for="gambar_produk" class="mb-2 block text-sm font-medium text-neutral-700">Gambar Produk</label>
                <input
                  type="file"
                  id="gambar_produk"
                  name="gambar_produk"
                ...
                />
                <p class="mt-2 text-xs text-neutral-400">Format yang didukung: JPG, PNG, atau GIF.</p>
              </div>
            </div>
